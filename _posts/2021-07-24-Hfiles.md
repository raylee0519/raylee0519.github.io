...
line에서 값을 입력받는데, 숫자를 입력받으면 *반복*이 계속 되다가, <br>
...
continue문을 거쳐서 아래의 문장을 한번 건너뛰고 다시 반복문으로 들어갑니다. <br>
...
### 4. goto문
goto문은 코드와 코드를 넘나드는 기능을 해줍니다. <br>
<U>코드 내의 위치를 나타내주는 역할을 하는 것</U>이 *레이블(Label)* 인데, <br>
**goto문은 레이블을 뛰어넘어버립니다.** <br>
...
그럼 이를 활용하여서 break문 예제를 조금 바꿔서 goto문을 사용해보겠습니다. <br>
